...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/fwwwjonnyaliblogblogspotcom)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/fwwwjonnyaliblogblogspotcom
```

A live public deployment of this template is available at [https://fwwwjonnyaliblogblogspotcom.templates.workers.dev](https://fwwwjonnyaliblogblogspotcom.templates.workers.dev)
